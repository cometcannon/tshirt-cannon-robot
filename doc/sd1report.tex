...
\noindent There were two main solutions to this problem that we found in our research. One solution uses signal response time to measure the distance to an object. These distances can then be analyzed over time to get a change in distance per unit time and the velocity can be calculated.\\
