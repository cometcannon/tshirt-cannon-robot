...
\chapter{Conceptual and Preliminary Design}
...
\noindent In the interest of safety, we have included in the power distribution system a kill switch that is triggered by physically pulling a bright orange lanyard. This cuts the power from the battery to all systems of the robot.\\

\noindent Figure \ref{fig:e_system} shows the design of the electrical system.

\chapter{Project Implementation and Future Work}

\section{T-Shirt Cannon}
\noindent The cannon we purchased has been tested manually and can achieve the desired range of 20 to 150 feet with a capacity of at least 20 shots. The electronic triggering and pressure regulation components have yet to be assembled and tested. This will be a priority task for next semester. Once this is completed we will mount the cannon onto the chassis.\\

\section{Chassis, Control Electronics, and Power Distribution System}
...
\chapter{Project Management Summary}
