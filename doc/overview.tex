...
\begin{table}[h!]
  ...
  \begin{tabular}{| c | c | c | c | c | c |}
    ...
    \textbf{Byte} & 0-3 & 4 & 5 & 6\\
    \hline
    \textbf{Description} & \specialcell{Magic\\Bytes} & \specialcell{Command\\Type} & \specialcell{Pressure\\MSB} & \specialcell{Pressure\\LSB} \\
    \hline
    \textbf{Value} & 0x47414e53 & 8 & 0-255 & 0-255 \\
    \hline
  \end{tabular}
