...
\begin{figure}[h!]
  ...
  \begin{tikzpicture}
    ...
    \node (circuitbreaker) [block, align=center, below of=battery, yshift=-5mm] {Circuit\\Breaker};
    \node (powerboard) [block, align=center, right of=circuitbreaker, minimum height=6cm, xshift=2cm] {Power\\Distribution\\Board};
    \node (boost) [block, align=center, right of=powerboard, minimum height=2cm, xshift=2cm, yshift=2cm] {Boost\\Converter};
    \node (buck) [block, align=center, right of=powerboard, minimum height=2cm, xshift=2cm, yshift=-2cm] {Buck\\Converter};
    \node (triggersolenoid) [block, align=center, right of=boost, yshift=7mm, xshift=3cm] {Trigger\\Solenoid};
    \node (pressuresolenoid) [block, align=center, right of=boost, yshift=-7mm, xshift=3cm] {Pressure\\Solenoid};
    \node (arduino) [block, align=center, right of=buck, xshift=3cm] {Arduino};
    \node (esc) [block, align=center, below of=arduino, xshift=12mm, yshift=-5mm] {Speed\\Controllers};
    \node (encoders) [block, align=center, below of=arduino, xshift=-12mm, yshift=-5mm] {Encoders};
    \node (rpi) [block, align=center, right of=arduino, xshift=2cm] {Raspberry\\Pi};
    \node (pressuresensor) [block, align=center, above of=arduino, xshift=-12mm, yshift=5mm] {Pressure\\Sensor};
    \node (controlboard) [block, align=center, above of=arduino, xshift=12mm, yshift=5mm] {Control\\Board};
  \end{tikzpicture}
