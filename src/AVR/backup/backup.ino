/*
 ...
 serial terminal for the Linux processor.

 Upload this to an Arduino Yun via serial (not WiFi) 
 then open the serial monitor at 115200 to see the boot process
 of the Linux processor. You can also use the serial monitor
 as a basic command line interface for the Linux processor using 
 this sketch.
